...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"assets/script/main.js":[function(require,module,exports) {
"use strict";
...
var API_URL = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=04c35731a5ee918f014970082a0088b1";
...
var searchBar = document.querySelector(".search-form__searchbar");
var modalbg = document.querySelector(".modal-bg"); //get all movies on load

getMovies(API_URL); //get the movies from api
...
function showMovies(movies) {
  ...
  movies.forEach(function (movie) {
    ...
    var movies = document.createElement("div"); //show movie poster, title and rating
...
searchForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var searchTerm = searchBar.value; //check if any char is written
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/script/main.js"], null)
